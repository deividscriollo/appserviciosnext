...
// return response()->json(array_map('utf8_encode', $datosSri));
        return array("mensaje"=>"Empresa registrada correctamente");
}else{
    return response()->json(array("mensaje"=>"Ruc Incorrecto"));
}
...
if ($datospersona['valid']=="true") {
        ...
        $tabla->save();
        // return response()->json(array_map('utf8_encode', $datospersona));
        return array("mensaje"=>"Persona registrada correctamente");
    }else{
    return response()->json(array("mensaje"=>"Cedula incorrecta"));
}
